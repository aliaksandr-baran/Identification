...
```
lectures/         L01–L11 poznámky v Markdown — slovenčina (hlavný výstup)
Exam_Prep_*.md    študijné príručky na skúšku — slovenčina
../en/            anglická verzia všetkého vyššie uvedeného
../transcripts/   surové .vtt titulky (zdieľané) použité na zostavenie poznámok
../Prednásky/     PDF prezentácií prednášajúcich (zdieľané)
../clean_vtt.py   odstraňuje VTT časové značky/tagy a duplicity z titulkov
```
