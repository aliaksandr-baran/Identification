...
```
lectures/         L01–L11 Markdown notes — English (the main deliverable)
Exam_Prep_*.md    exam study guides — English
../sk/            the Slovak version of all of the above
../transcripts/   raw .vtt caption downloads (shared) used to build the notes
../Prednásky/     the lecturers' slide PDFs (shared)
